...
setpoint_event = mavutil.periodic_event(SETPOINT_FREQUENCY)
        ...
        while True:
            ...
            if streaming_global_pos and setpoint_event.trigger():
                if logic.target_pos != None:
                    ...
                    target_pos_gra = GRA.get_position_from_cache(lg_conn)
                    if target_pos_gra is not None:
...
class VehicleLogic:
    ...
    def __init__(
        ...
        self.set_loiter = make_set_mode(base_mode=217,
                                        main_mode=CustomMainMode.PX4_CUSTOM_MAIN_MODE_AUTO,
