...
from typing import Generator, NamedTuple, Self, Type, TypeVar
...
def float_nans(n: int) -> Generator[float, None, None]:
    """Create a NaN instance for any NamedTuple class."""
...
# create a nan LLA as a static variable
...
# Add a None GRA type to indicate unknown position
class GRA(LLA):
